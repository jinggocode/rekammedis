              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <tr>
                      ...
                      <td>
                        <?php 
                        $pasien = $this->m_pasien->edit($pemeriksaan['no_rm']);
                        echo $pasien->nama; 
                        ?>
                      </td>
                      <td>
                        <?php 
                        $penyakit = $this->m_penyakit->edit($pemeriksaan['kd_penyakit']);
                        echo $penyakit->nm_penyakit; 
                        ?>
                      </td>
                      <td>
                        <?php
                        $obatdigunakan = $this->m_obatdigunakan->edit($pemeriksaan['kd_obat_digunakan']);
                        $obat = $this->m_obat->edit($obatdigunakan->kd_obat);
                        echo $obat['nm_obat']; ?>
                      </td>
