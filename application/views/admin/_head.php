<?php
    ...
    $row=$this->db->query("SELECT * FROM admin WHERE kd_admin='$id'")->row_array();
    if(empty($id)){
      redirect('login');
    }
 ?>
...
<head>
  ...
  <title>Rekamedis Poliklinik</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Rekamedis</b> Poliklinik</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $row['nm_admin']?></span>
            </a>
