      ...
      <div class="box">
            ...
            <div class="box-body">
              <form method="post" enctype="multipart/form-data" action="<?php echo site_url('pemeriksaan/add')?>">
                ...
                <div class="form-group">
                  <label>Keluhan</label>
                  <input type="text" name="keluhan" class="form-control" placeholder="Enter ...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="kd_obat_digunakan" class="form-control">
                    <?php 
                       echo '<option value=""> -- Obat Digunakan -- </option>';
